...
import { agreementsApi, type AgreementStatus } from "@/lib/api/agreements";
...
const EMPTY = {
  ...
  introParagraph:
    "This Service Agreement sets out the terms under which the Service Provider will deliver the services described below.",
  note:            "",
  ...
  termsConditions: ["This agreement is valid for the duration stated above unless terminated earlier by either party."],
};
...
export default function NewAgreementPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setApiError(err instanceof Error ? err.message : "Failed to save agreement");
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="max-w-3xl mx-auto space-y-6 p-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-slate-900">Create Agreement</h1>
        </div>
